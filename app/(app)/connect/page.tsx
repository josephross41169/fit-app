...
function ConnectSidebar({ tab }: { tab: "local" | "online" }) {
  ...
  return (
    <div className="connect-sidebar" style={{ width:320, flexShrink:0, paddingTop:20, paddingBottom:20 }}>
      ...
      {/* Create a group CTA */}
      <div style={{ background:`linear-gradient(135deg,${tab==="local"?"#16A34A,#22C55E":"#16A34A,#15803D"})`, borderRadius:18, padding:"20px", marginBottom:20, boxShadow:`0 4px 20px ${tab==="local"?"rgba(124,58,237,0.3)":"rgba(124,58,237,0.3)"}` }}>
    ...
    <div style={{ background:C.bg, minHeight:"100vh" }}>
      ...
      <div className="connect-layout" style={{ display:"flex", gap:48, maxWidth:1200, margin:"0 auto", padding:"24px 24px 60px", alignItems:"flex-start" }}>
        ...
        <div style={{ flex:1, minWidth:0 }}>
          ...
          {/* Banner */}
          <div style={{
            background: tab==="local" ? "linear-gradient(135deg,#16A34A,#22C55E)" : `linear-gradient(135deg,${C.blue},#15803D)`,
            borderRadius:18, padding:"18px 22px", marginBottom:24,
            display:"flex", alignItems:"center", gap:16,
            boxShadow: tab==="local" ? "0 4px 20px rgba(124,58,237,0.3)" : "0 4px 20px rgba(124,58,237,0.3)",
          }}>
